...
var MainManager = function () {
    ...
    function i(a) {
      (X = !X) ? ($("#bt_backtrack a").text("背景音樂: 開啟"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("背景音樂: 關閉"), aidn.util.setCookie("bt", "off", 2592e3)), a && a.preventDefault()
    }
    ...
    p && ($("#bt_fs").css("display", "block"), $("#bt_fs").click(function (a) {
      ...
      switch (g) {
        case 1:
          ...
          break;
        default:
          location.href = "https://mdecp2018.github.io/site-s40723210/"
      }
    ...
    var w, M, I, x, b, C = 0,
      ...
      P = new function () {
        ...
        this.init = function (t, o) {
          ...
          (n = new WebAudioManager).load("/data/track/", r, a, e)
      ...
      T = new function () {
        ...
        this.init = function (n, t) {
          ...
          (i = new WebAudioManager).load("/data/main/", r, a, e)
    ...
    i(), aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("輕觸 &amp; 滑動!"), u || $("#scene_top .attention").text("* 把聲音開大點，然後享受吧！")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("抱歉，</br>你的瀏覽器不支此頁面")), PIXI.utils._saidHello = !0, aidn.window.resize(a)
  },
